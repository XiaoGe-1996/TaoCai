...
import com.my.aicai.util.ImageTitleBean;
...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.ViewHolder> {
    ...
    public OrderListAdapter(Context mContext,List<OrderClass> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        switch (item.getStatus()) {
            ...
            case "2":
                ...
                holder.btn_action.setVisibility(View.VISIBLE);
                holder.btn_action.setText("确认收货");
                break;
            case "3":
    ...
    public void setOnMyclick(OrderListAdapter.onMyclick onMyclick) {
